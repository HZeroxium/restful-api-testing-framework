...
def convert_json_to_excel_request_response_constraints(
    json_file, openapi_spec_file, output_file
):
...
def main():
    ...
    for service_name in service_names:
        json_file = (
            f"{output_folder}/{service_name} API/request_response_constraints.json"
        )
        openapi_spec_file = f"{dataset_folder}/{service_name}/openapi.json"
        output_file = (
            f"{output_folder}/{service_name} API/request_response_constraints.xlsx"
        )
